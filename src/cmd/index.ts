...
export default [
    ...
    { keyword: '주문현황', func: showOrderGroupByMenu, usage: '메뉴별 주문현황을 조회합니다. 특정일자를 조회할 경우 "주문현황 20170325"와 같이 입력해주세요.' },
    { keyword: '주문목록', func: showOrderGroupByUser, usage: '주문자별 주문목록을 조회합니다. 특정일자를 조회할 경우 "주문목록 20170325"와 같이 입력해주세요.' },
